...
urlpatterns = [
    ...
    path('incoming-requests/', views.incoming_service_requests, name='incoming_service_requests'),
    path('requests/<uuid:request_id>/accept/', views.service_request_accept, name='service_request_accept'),
    path('requests/<uuid:request_id>/reject/', views.service_request_reject, name='service_request_reject'),
